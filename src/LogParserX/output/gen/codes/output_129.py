...
if __name__ == '__main__':
    ...
    print(json_data)
```
This code will extract the required fields from the log text and return them in the specified format. The patterns are optimized to handle the given log format and ensure accurate extraction of key-value pairs, dates, hostnames, and IP-port combinations.