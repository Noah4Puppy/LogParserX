...
if __name__ == '__main__':
    ...
    print(json_data)
```
This code defines a set of functions to match and extract specific fields from the log text using optimized regular expressions. The `get_components` function combines the results from these functions to produce the final list of key-value pairs. The main block demonstrates how to call `get_components` and print the results in JSON format.