...
if __name__ == '__main__':
    ...
    print(res)
```
This code defines functions to match and extract specific components from the log text using the optimized patterns. The `get_components` function combines the results from these individual functions and returns the extracted components in the required format. The main block demonstrates how to use the `get_components` function with a sample log text and prints the results.