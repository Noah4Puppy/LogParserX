...
if __name__ == '__main__':
    ...
    print(res)
```
This code defines a set of functions to match and extract specific fields from the log text using the optimized patterns. The `get_components` function combines the results from all the individual matching functions and returns a list of dictionaries containing the extracted key-value pairs. The main block demonstrates how to call the `get_components` function and print the results.