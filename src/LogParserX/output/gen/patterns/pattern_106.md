...
- **Date Patterns**: Multiple date patterns are provided to cover different date formats, including both short and long date formats.
- **Hostname and PID Patterns**: These patterns are designed to extract hostnames and process IDs accurately.
- **IP and Port Patterns**: These patterns handle different formats of IP addresses and ports, ensuring that they are correctly parsed.
...
- **Attack Info Patterns**: These patterns are designed to extract information about web attacks and system alerts.
- **JSON String Pattern**: This pattern is designed to extract JSON key-value pairs.
- **Target Keys Pattern**: This pattern is designed to extract specific target keys from the log text.
- **Keyword Extraction Pattern**: This pattern is designed to extract specific keywords from the log text.
