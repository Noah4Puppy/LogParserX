...
if __name__ == '__main__':
    log_text = f"""<178>Nov 15 14:22:45 10-50-86-13 DBAppWAF: 发生时间/2024-11-15 14:22:35,威胁/中,事件/检测SQL注入,请求方法/POST,URL地址/10.50.109.3/api/login,POST数据/username=admin&password=123456,服务器IP/10.50.109.3,主机名/10.50.109.3,服务器端口/80,客户端IP/10.50.86.45,客户端端口/49152,客户端环境/Mozilla/5.0 [en] (X11, U; DBAPPSecurity 21.4.3),标签/SQL注入,动作/阻断,HTTP/S响应码/403,攻击特征串/123456,触发规则/10110001,访问唯一编号/7428040668791968651,国家/局域网,省/未知,市/未知,XFF_IP/"""
