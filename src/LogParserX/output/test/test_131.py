...
if __name__ == '__main__':
    log_text = f"""<178>Oct 21 10:05:12 10-50-86-12 DBAppWAF: 发生时间/2024-10-21 10:05:08,威胁/中,事件/检测SQL注入,请求方法/POST,URL地址/10.50.109.2/admin/login.php,POST数据/username=admin&password=123456,服务器IP/10.50.109.2,主机名/10.50.109.2,服务器端口/80,客户端IP/10.50.86.36,客户端端口/58263,客户端环境/Mozilla/5.0 [en] (X11, U; DBAPPSecurity 21.4.3),标签/通用防护,动作/告警,HTTP/S响应码/403,攻击特征串/123456,触发规则/10240001,访问唯一编号/7428041484838900914,国家/局域网,省/未知,市/未知,XFF_IP/"""
