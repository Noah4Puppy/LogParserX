...
if __name__ == '__main__':
    log_text = f"""<178>Nov 15 14:30:22 10-50-86-15 DBAppWAF: 发生时间/2024-11-15 14:30:15,威胁/高,事件/检测SQL注入攻击,请求方法/POST,URL地址/10.50.109.2/admin/login.php?username=admin&password=123456,POST数据/username=admin&password=123456,服务器IP/10.50.109.2,主机名/10.50.109.2,服务器端口/80,客户端IP/10.50.86.40,客户端端口/59234,客户端环境/Mozilla/5.0 [en] (X11, U; DBAPPSecurity 21.4.3),标签/SQL注入,动作/阻断,HTTP/S响应码/403,攻击特征串/username=admin&password=123456,触发规则/10350001,访问唯一编号/7428041003791029280,国家/局域网,省/未知,市/未知,XFF_IP/"""
