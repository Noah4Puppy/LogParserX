...
if __name__ == '__main__':
    log_text = f"""<178>Dec 20 10:25:30 10-50-86-12 DBAppWAF: 发生时间/2024-12-20 10:25:27,威胁/中,事件/检测SQL注入,请求方法/POST,URL地址/10.50.109.90/api/login,POST数据/username=admin&password=123456,服务器IP/10.50.109.90,主机名/10.50.109.90,服务器端口/8080,客户端IP/10.50.24.198,客户端端口/55555,客户端环境/Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.121 Safari/537.36,标签/SQL注入防护,动作/阻断,HTTP/S响应码/403,攻击特征串/1' OR '1'='1,触发规则/10110001,访问唯一编号/7438514942982013156,国家/局域网,省/未知,市/未知,XFF_IP/"""
