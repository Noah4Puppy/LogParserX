...
if __name__ == '__main__':
    log_text = f"""<178>Nov 15 14:22:45 10-50-86-13 DBAppWAF: 发生时间/2024-11-15 14:22:37,威胁/中,事件/检测XSS攻击,请求方法/POST,URL地址/10.50.109.2/login.php?user=admin&password=123456,POST数据/user=admin&password=123456,服务器IP/10.50.109.2,主机名/10.50.109.2,服务器端口/80,客户端IP/10.50.86.36,客户端端口/50436,客户端环境/Mozilla/5.0 [en] (X11, U; DBAPPSecurity 21.4.3),标签/通用防护,动作/阻断,HTTP/S响应码/403,攻击特征串/user=admin&password=123456,触发规则/10120001,访问唯一编号/7428040578590315359,国家/局域网,省/未知,市/未知,XFF_IP/"""
