...
if __name__ == '__main__':
    log_text = f"""<178>Oct 15 01:05:22 10-50-86-12 DBAppWAF: 发生时间/2024-10-15 01:05:18,威胁/中,事件/检测到SQL注入尝试,请求方法/POST,URL地址//admin/login.php,POST数据/user=admin&password=123456,服务器IP/10.50.109.2,主机名/,服务器端口/8300,客户端IP/10.20.170.23,客户端端口/44955,客户端环境/,标签/SQL注入,动作/阻断,HTTP/S响应码/403,攻击特征串/admin/login.php,触发规则/10113001,访问唯一编号/7425677762474543173,国家/局域网,省/未知,市/未知,XFF_IP/"""
