...
if __name__ == '__main__':
    log_text = f"""<178>Nov 15 14:22:30 10.50.81.60 DBAppWAF: 发生时间/2024-11-15 14:22:28,威胁/中,事件/SQL注入,请求方法/POST,URL地址/10.50.81.60:8000/admin/login.php?username=admin&password=123456,POST数据/username=admin&password=123456,服务器IP/10.50.81.6,主机名/10.50.81.60:8000,服务器端口/8000,客户端IP/10.20.170.23,客户端端口/54321,客户端环境/Mozilla/5.0 [en] (X11, U; DBAPPSecurity 21.4.3),标签/SQL注入(语法/语义分析),动作/阻断,HTTP/S响应码/403,攻击特征串/admin/login.php?username=admin&password=123456,触发规则/13100002,访问唯一编号/7425395437085917362,国家/LAN,省/,市/,XFF_IP/"""
