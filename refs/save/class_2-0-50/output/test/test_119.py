...
if __name__ == '__main__':
    log_text = f"""<178>Dec 20 10:25:12 10-50-86-12 DBAppWAF: 发生时间/2024-12-20 10:25:05,威胁/低,事件/检测恶意软件,请求方法/POST,URL地址/10.50.109.90:31003/api/v1/login,POST数据/user=admin&password=123456,服务器IP/10.50.109.90,主机名/10.50.109.90:31003,服务器端口/31003,客户端IP/10.50.24.198,客户端端口/40600,客户端环境/curl/7.54.0,标签/恶意软件,动作/警告,HTTP/S响应码/401,攻击特征串/curl,触发规则/10502001,访问唯一编号/7438514668100959794,国家/局域网,省/未知,市/未知,XFF_IP/"""
