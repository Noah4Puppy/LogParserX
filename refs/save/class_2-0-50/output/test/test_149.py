...
if __name__ == '__main__':
    log_text = f"""<178>Dec 20 10:22:15 10-50-86-12 DBAppWAF: 发生时间/2024-12-20 10:21:59,威胁/中,事件/检测SQL注入,请求方法/POST,URL地址/10.50.109.90:31003/api/v1/login,POST数据/username=admin&password=123456,服务器IP/10.50.109.90,主机名/10.50.109.90:31003,服务器端口/31003,客户端IP/10.50.24.198,客户端端口/52483,客户端环境/SELECT * FROM users WHERE username='admin' AND password='123456';--,标签/通用防护,动作/阻断,HTTP/S响应码/403,攻击特征串/SELECT * FROM users WHERE username='admin' AND password='123456';--,触发规则/10190001,访问唯一编号/7438514616550866183,国家/局域网,省/未知,市/未知,XFF_IP/"""
