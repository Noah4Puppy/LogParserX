...
if __name__ == '__main__':
    log_text = f"""<178>Nov 1 15:22:45 10.50.81.60 DBAppWAF: 发生时间/2024-11-01 15:22:41,威胁/中,事件/SQL注入,请求方法/POST,URL地址/hostname/api/v1/users/login,POST数据/username=admin&password=123456,服务器IP/10.50.81.6,主机名/hostname,服务器端口/8080,客户端IP/10.24.2.14,客户端端口/12612,客户端环境/Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36,标签/SQL注入,动作/警告,HTTP/S响应码/403,攻击特征串/username=admin&password=123456,触发规则/14070007,访问唯一编号/7431919479520496054,国家/LAN,省/,市/,XFF_IP/"""
