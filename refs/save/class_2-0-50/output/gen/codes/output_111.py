...
if __name__ == '__main__':
    ...
    print(json_data)
```
This code will parse the provided log text and extract the required fields, matching them to the specified log fields. The patterns are optimized to handle various formats and ensure accurate extraction.