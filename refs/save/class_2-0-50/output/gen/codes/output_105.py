...
if __name__ == '__main__':
    ...
    print(json_data)
```
This code will extract the specified fields from the log text and return them in the desired format. The patterns are optimized to handle the given log format and ensure accurate extraction of the required information.