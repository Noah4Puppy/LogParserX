...
if __name__ == '__main__':
    ...
    print(json_data)
```
This code defines a set of functions to extract various components from the log text using the optimized regular expressions. The `get_components` function combines the results from all these functions and returns a list of dictionaries containing the extracted key-value pairs. The main block demonstrates how to use the `get_components` function and prints the results in JSON format.