...
if __name__ == '__main__':
    ...
    print(json_data)
```
This code defines a set of functions to match various patterns in the log text and returns the extracted components in a structured format. The `get_components` function combines the results from all the individual pattern-matching functions and returns the final list of key-value pairs. The main block demonstrates how to use the `get_components` function with a sample log text and prints the results in JSON format.