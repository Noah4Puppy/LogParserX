...
if __name__ == '__main__':
    ...
    print(res)
```
This code defines functions to match and extract specific patterns from the log text and combines them to produce the desired output. The `get_components` function calls each matching function and aggregates the results. The main block demonstrates how to use the `get_components` function with a sample log text.