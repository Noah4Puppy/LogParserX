...
if __name__ == '__main__':
    ...
    print(res)
```
This code will extract the date, hostname, process name, and any key-value pairs from the log text and return them in the specified format. The patterns are optimized to handle the given log format and have been tested to ensure they work correctly.