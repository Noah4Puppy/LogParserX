...
if __name__ == '__main__':
    ...
    print(res)
```
This code will extract the required fields from the log text and return them in the specified format. Each function is responsible for matching a specific pattern, and the `get_components` function combines the results from all the individual match functions. The `if __name__ == '__main__':` block demonstrates how to use the `get_components` function with a sample log text.