...
if __name__ == '__main__':
    ...
    print(res)
```
This code defines the necessary functions to extract the required fields from the log text using the optimized regular expressions. It then combines the results from each function to produce the final list of extracted fields. The `get_components` function is the main entry point, and it is tested with the provided log text to ensure correctness.